...
- [Inventory System - 用户使用指南](#inventory-system---用户使用指南)
  ...
  - [常见场景](#常见场景)
    ...
    - [场景 5：使用 InventoryService 管理多个容器](#场景-5使用-inventoryservice-管理多个容器)
  - [进阶用法](#进阶用法)
  ...
  - [术语表](#术语表)
    ...
    - [InventoryService（库存服务）](#inventoryservice库存服务)
    - [批处理（Batch Processing）](#批处理batch-processing)
    - [网格物品（Grid Item）](#网格物品grid-item)
  - [最佳实践](#最佳实践)
    - [1. 优先使用 InventoryService 管理多个容器](#1-优先使用-inventoryservice-管理多个容器)
