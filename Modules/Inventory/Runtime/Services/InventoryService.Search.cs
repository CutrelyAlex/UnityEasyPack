...
namespace EasyPack.InventorySystem
{
    ...
    public partial class InventoryService
    {
        ...
        public List<GlobalItemResult> FindItemGlobally(string itemId)
        {
            ...
            if (!IsServiceAvailable() || string.IsNullOrEmpty(itemId)) return results;
        ...
        {
            if (!IsServiceAvailable() || string.IsNullOrEmpty(itemId)) return 0;
        ...
        public List<GlobalItemResult> SearchItemsByCondition(System.Func<IItem, bool> condition)
        {
            ...
            if (!IsServiceAvailable() || condition == null) return results;
        ...
        public List<GlobalItemResult> SearchItemsByType(string itemType)
        {
            ...
            if (!IsServiceAvailable() || string.IsNullOrEmpty(itemType)) return results;
        ...
        public List<GlobalItemResult> SearchItemsByName(string namePattern)
        {
            ...
            if (!IsServiceAvailable() || string.IsNullOrEmpty(namePattern)) return results;
        ...
        public List<GlobalItemResult> SearchItemsByAttribute(string attributeName, object attributeValue)
        {
            ...
            if (!IsServiceAvailable() || string.IsNullOrEmpty(attributeName)) return results;
