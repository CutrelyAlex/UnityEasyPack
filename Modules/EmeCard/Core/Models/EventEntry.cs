...
namespace EasyPack.EmeCardSystem
{
    ...
    public readonly struct CardEventEntry : IEventEntry
    {
        ...
        {
            return $"CardEventEntry[Source={SourceCard?.Id ?? "null"}, Event={Event.EventType}:{Event.EventId}, Priority={Priority}]";
        }
    }
    ...
    public readonly struct RuleEventEntry : IEventEntry
    {
        ...
        public RuleEventEntry(int ruleUID, ICardEvent @event, Card sourceCard = null, Card effectRoot = null, int priority = 0)
        {
        ...
        public override string ToString()
        {
            return $"RuleEventEntry[RuleUID={SourceRuleUID}, Event={Event.EventType}:{Event.EventId}, Source={SourceCard?.Id ?? "null"}, Priority={Priority}]";
        }
    }
    ...
    public readonly struct SystemEventEntry : IEventEntry
    {
        ...
        public override string ToString()
        {
            return $"SystemEventEntry[Event={Event.EventType}:{Event.EventId}, Priority={Priority}]";
        }
    }
    ...
    public readonly struct ExternalEventEntry : IEventEntry
    {
        ...
        public override string ToString()
        {
            return $"ExternalEventEntry[Event={Event.EventType}:{Event.EventId}, Source={SourceCard?.Id ?? "null"}, Priority={Priority}]";
        }
    }
}
