...
namespace EasyPack.EmeCardSystem
{
    ...
    public sealed class CardRuleContext
    {
        ...
        public CardRuleContext(Card source, Card matchRoot, ICardEvent @event, ICardFactory factory, int maxDepth)
        {
            ...
            EventEntry = new CardEventEntry(source, @event, effectRoot: matchRoot);
            MatchRoot = matchRoot;
        ...
        public bool IsEventType(string eventType)
        {
        ...
        /// <returns>如果匹配返回 true。</returns>
        public bool IsEventType<T>(CardEventDefinition<T> eventDef)
        {
            return eventDef?.Matches(Event) ?? false;
        }
