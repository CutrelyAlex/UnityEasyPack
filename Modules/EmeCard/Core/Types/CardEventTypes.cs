namespace EasyPack.EmeCardSystem
{
    ...
    public static class CardEventTypes
    {
        ...
        /// </summary>
        public static readonly CardEventDefinition<float> Tick =
            new CardEventDefinition<float>(TICK);
        ...
        /// 添加到容器事件：携带目标容器卡牌。
        /// </summary>
        public static readonly CardEventDefinition<Card> AddedToOwner =
            new CardEventDefinition<Card>(ADDED_TO_OWNER);

        /// <summary>
        /// 从容器移除事件：携带原容器卡牌。
        /// </summary>
        public static readonly CardEventDefinition<Card> RemovedFromOwner =
            new CardEventDefinition<Card>(REMOVED_FROM_OWNER);
        ...
        /// </summary>
        public static readonly CardEventDefinition<Card> Use =
            new CardEventDefinition<Card>(USE);
        ...
        public static CardEventDefinition<TData> Define<TData>(string eventType)
        {
            return new CardEventDefinition<TData>(eventType);
        }
        ...
        public static CardEventDefinition<object> Define(string eventType)
        {
            return new CardEventDefinition<object>(eventType);
        }
        ...
        {
            return new CardEvent<TData>(eventType, data, eventId);
        }
