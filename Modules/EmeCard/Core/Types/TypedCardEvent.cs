...
namespace EasyPack.EmeCardSystem
{
    ...
    public readonly struct CardEvent<TData> : ICardEvent<TData>
    {
        ...
        public override string ToString()
        {
            return $"CardEvent<{typeof(TData).Name}>[Type={EventType}, Id={EventId}, Data={Data}]";
        }
        ...
        {
            return new CardEvent<object>(evt.EventType, evt.Data, evt.EventId);
        }
    }
    ...
    public class CardEventDefinition<TData>
    {
        ...
        public CardEvent<TData> Create(TData data, string eventId = null)
        {
        ...
        public bool Matches(ICardEvent evt)
        {
            return evt != null && evt.EventType == EventType;
        }
