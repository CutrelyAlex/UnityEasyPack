...
namespace EasyPack.ENekoFramework.Editor
{
    ...
    public class EditorMonitoringPreferences : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            bool eventEnabled = EditorMonitoringConfig.EnableEventMonitoring;
            bool newEventState = EditorGUILayout.Toggle("启用事件监控", eventEnabled);
            if (newEventState != eventEnabled) EditorMonitoringConfig.EnableEventMonitoring = newEventState;
            ...
            bool serviceEnabled = EditorMonitoringConfig.EnableServiceMonitoring;
            bool newServiceState = EditorGUILayout.Toggle("启用服务监控", serviceEnabled);
            if (newServiceState != serviceEnabled) EditorMonitoringConfig.EnableServiceMonitoring = newServiceState;
            ...
            bool commandEnabled = EditorMonitoringConfig.EnableCommandMonitoring;
            bool newCommandState = EditorGUILayout.Toggle("启用命令监控", commandEnabled);
            if (newCommandState != commandEnabled) EditorMonitoringConfig.EnableCommandMonitoring = newCommandState;
            ...
            if (GUILayout.Button("恢复默认设置")) EditorMonitoringConfig.ResetToDefault();
